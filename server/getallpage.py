...
class Spider1024(threading.Thread):
	...
	def get_content(self,url,pattern,pattern2=''):
		try:
			page_url = self.url
			request = urllib2.Request(url,headers={'user-agent':randomUA.random_ua(),'cookie':'__cfduid=d50071b2a7f9ad6ebd19e90bb50be84981452179480; 227c9_lastfid=0; 227c9_lastvisit=0%091452179585%09%2Fprofile.php%3Faction%3Dshow%26uid%3D18844; CNZZDATA950900=cnzz_eid%3D970883499-1452175128-%26ntime%3D1452434344'})
